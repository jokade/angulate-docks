...
lazy val commonSettings = Seq(
  ...
  scalacOptions ++= (if (isSnapshot.value) Seq.empty else Seq({
        ...
        val g = "https://raw.githubusercontent.com/jokade/angulate-docks"
        s"-P:scalajs:mapSourceURI:$a->$g/v${version.value}/"
      }))
)


lazy val docks = project.in(file(".")).
...
lazy val publishingSettings = Seq(
  ...
  pomExtra := (
    <url>https://github.com/jokade/angulate-docks</url>
    <licenses>
      <license>
    ...
    <scm>
      <url>git@github.com:jokade/angulate-docks</url>
      <connection>scm:git:git@github.com:jokade/angulate-docks.git</connection>
    </scm>
    <developers>
      <developer>
        <id>jokade</id>
